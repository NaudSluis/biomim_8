...
export PATH=$PATH:/home/group8/bin/
...
arduino-cli compile --fqbn arduino:avr:uno arduino_code/wash_loop
if [ $? -ne 0 ]; then
...
# upload arduino code
arduino-cli upload -p /dev/ttyUSB0 --fqbn arduino:avr:uno arduino_code/wash_loop
if [ $? -ne 0 ]; then
